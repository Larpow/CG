package com.cgvsu.andreeva_m_n.cg.task_3.objreader;

import com.cgvsu.andreeva_m_n.cg.task_3.Vector2f;
import com.cgvsu.andreeva_m_n.cg.task_3.Vector3f;
import com.cgvsu.andreeva_m_n.cg.task_3.model.Model;
import com.cgvsu.andreeva_m_n.cg.task_3.model.Polygon;
...
public class ObjReader {
	...
	protected static Polygon parseFace(final ArrayList<String> wordsInLineWithoutToken, int lineInd) {
		...
		//информация в строке, описывающей полигон, раскидывается по нужным спискам
		for (String s : wordsInLineWithoutToken) {
			parseFaceWord(s, onePolygonVertexIndices, onePolygonTextureVertexIndices, onePolygonNormalIndices, lineInd);
		}
		//создаем новый полигон и закрепляем за ним полученные списки
